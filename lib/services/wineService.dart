...
class WineService {
  ...
  //final String baseUrl = "http://10.0.2.2:3000/api/wine"; // URL de tu backend Android
  final String baseUrl = "http://apiwiner.duckdns.org:5000/api/wine"; // URL de tu backend Android
